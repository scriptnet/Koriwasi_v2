...
<!-- End Earning Sources -->
<!-- Copyright -->
  <div class="container text-center u-space-1" ng-repeat="bdio in bdio" style="padding-top: 100px;">
    <!-- Logo -->
    <a class="d-inline-block mb-2" href="{{ bdio.link }}" aria-label="Front">
      <img ng-src="{{ bdio.logo }}" alt="Logo" style="width: 120px;">
    </a>
    <!-- End Logo -->
    <p class="small text-muted">© {{ bdio.nombre }}. 2018. Todos los derechos reservados.</p>
  </div>
  <!-- End Copyright -->

  <ul ng-repeat="general in general">
    <li>{{general.nombre}}</li>
  </ul>
